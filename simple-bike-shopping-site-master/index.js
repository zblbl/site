...
<head>
    ...
    <title>Leopard | Presenting India Ka Bike | India's Fastest Bike Ever</title>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarsExampleDefault">
                <ul class="navbar-nav ">
                    ...
                    <li class="nav-item">
                     ...
                     <li class="nav-item">
                        <a class="nav-link" href="#mail">Order
                            <span class="sr-only">(current)</span>
                        </a>
                    </li>
    ...
    <main>
        <section>
            <div class="wellcome">
                <div class="wellcomeMsg">
                    <div class="headTag">Leopard</div>
                    <div class="subTag">Presenting India ka Bike | India's Fastest Bike Ever</div>
                </div>
            </div>
        </section>
        ...
        <section id="shop">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="item-box">
                            ...
                            <div class="item-box-head">Cloths</div>
                            <div class="item-box-sub-text">Lorem ipsum dolor sit amet consectetur adipisicing elit.</div>
                            <button class="btn item-box-btn">Shop Now</button>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card">
                            <img class="card-img-top" src="./img/bike.jpg" alt="bike">
        ...
        <section id="about">
            <div class="container">
                ...
                <br>
                <p>
                    Some text about me. Some text about me. I am lorem ipsum consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
        ...
        <section id="contact">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li>Permskiy kray,Perm</li>
                            <li>Pobedi street,17</li>
                            <li>Pin: 700XXX</li>
                            <li>Phone: +79 9xxxxxxxx</li>
         ...
         <section id="mail">
            <div class="container">
                <div class="sectionHead">Order a bike</div>
                <hr>
                <br>
                <div class="row">
                    <div class="col-md-7">
                        <div class="row">
                            <div class="col-md-6 offset-md-2">
                                <h4 class="sectionSubSubHead text-capitalize">Write down all of the needed information</h4>
                                <form>
                                   
      <div class="form-group">
                                    <div class="form-group">
                                        Choose a bike's model
                                        <select id="selectID" class="form-control">

<option value=”GR”>Ducati Desert X</option>

<option value=”YE”>IRBIS TTR 250X</option>

<option value=”BL”>MOTAX 50CC</option>
<option value=”BL”>APRILIA RS660</option>

</select>
</div>
      <div class="form-group">
                                         Choose amount of products to order
                                        <select id="selectID" class="form-control">

<option value=”GR”>1</option>

<option value=”YE”>2</option>

<option value=”BL”>3</option>
<option value=”BL”>4</option>

</select>
</div>
                                   
                                    <div class="form-group">
                                        <input type="tel" class="form-control" required placeholder="Promo code(if you have one)*">
                                    </div>
                                    <div class="form-group">
                                        <textarea type="text" class="form-control" required placeholder="suggestions for order collection*"></textarea>
                                    </div>
                                    <div class="form-group">
